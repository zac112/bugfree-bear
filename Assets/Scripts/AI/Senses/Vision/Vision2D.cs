...
public class Vision2D : Sense
{
	...
	private float timer;
	private Action<RaycastHit2D, List<RaycastHit2D>> onSeen = delegate { };
	private FOVRenderer fov;
	private bool clearedFov;
	private Transform cachedTransform;

	public Action<RaycastHit2D, List<RaycastHit2D>> OnSeen
	{
		get { return onSeen; }
		set { onSeen = value; }
	}
	...
	private void CastRays()
	{
		...
		{
			Vector3 dir = Quaternion.Euler(0f, 0f, -currentAngle) * cachedTransform.up;
