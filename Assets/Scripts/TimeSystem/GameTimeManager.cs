...
public class GameTimeManager : MonoBehaviour
{
	...
	public static void ReceiveNotificationAt(GameTime time, Action action)
	{
	...
	private class NotificationReceiver : IComparable<NotificationReceiver>
	{
		...
		public NotificationReceiver(GameTime time, Action action)
		{
			this.time = time;
			this.action = action;
		}
	...
	{
		public MutableGameTime(float gameTime)
			: base(gameTime)
		{
		}
